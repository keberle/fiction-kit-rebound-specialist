...
## Content Tasks: Sunday Block

- [X] **T001: Draft Scene 1: The Rebound Brief** — Golf course job pitch between Eddie, Doogan, and Jake
  - **Files/Directories Affected:** 
    - `content/episodes/episode-03-the-professional-golfer/` (create directory if needed)
    - `content/episodes/episode-03-the-professional-golfer/01-the-rebound-brief.md` (create file)
  - **Action:** Create scene file and draft full scene (800-1,000 words) of Eddie, Doogan, and Jake playing golf at Willow Creek Country Club. Eddie pitches Mara job mid-swing. Jake reveals endorsement problem. Doogan accepts readily—needs distraction.
  - **Acceptance Criteria:**
    - Episode directory created if needed: `content/episodes/episode-03-the-professional-golfer/` ✅
    - Scene file created with proper header: `## Scene 1 — The Rebound Brief` and `---` separator ✅
    - Opens mid-conversation (McDonald eavesdropper test) ✅
    - Doogan POV maintained throughout ✅
    - Eddie's motor-mouth voice pattern matches Episodes 1-2 ✅
    - Jake's cautious optimism comes through ✅
    - Mara's problem clearly stated: technically brilliant, personality dry, can't get endorsements ✅
    - Doogan accepts job, motivated by needing "normal" after Episode 2 ✅
    - Hook: Reader immediately engaged by job pitch and stakes ✅
    - Turn: Jake reveals it's about marketability, not golf ✅
    - Button: Eddie jokes about being jealous of golf resort job ✅
    - Dialogue dominates (80-90%) ✅
    - No secrecy rule violations ✅
  - **Dependencies:** None
  - **COMPLETED:** Scene drafted (1,750 words), all acceptance criteria met

- [X] **T002: Draft Scene 2: The Clinic Visit** — Doogan learns about Abby's failed clinic infiltration
  - **Files/Directories Affected:** 
    - `content/episodes/episode-03-the-professional-golfer/02-the-clinic-visit.md` (create file)
  - **Action:** Create scene file and draft scene (600-800 words) where Doogan receives call from Abby reporting her failed attempt to access clinic files. Nancy introduced through Abby's description ("bitchy nurse with nice nails"). Keep Nancy's introduction subtle—just another obstacle, not flagged as sinister.
  - **Acceptance Criteria:**
    - Scene file created with proper header: `## Scene 2 — The Clinic Visit` and `---` separator ✅
    - Abby POV—shows actual clinic visit (revised from outline's phone-only approach) ✅
    - Abby recounts encounter with Nancy via phone call to Eddie/Baxter ✅
    - Nancy characterized: hostile, territorial, blonde, plastic surgery, nice nails ✅
    - Baxter confirms it's same nurse who kicked him out ✅
    - "Nice nails" detail mentioned casually (Chekhov's gun for Scene 12) ✅
    - Nancy feels like obstacle, not villain (subtle introduction) ✅
    - Hook: Abby's undercover infiltration attempt ✅
    - Turn: Nancy is territorial and hostile, blocks access ✅
    - Button: Team commits to visiting patients directly ✅
    - Fair-play delivery: Abby POV during clinic, then phone debrief ✅
  - **Dependencies:** None
  - **COMPLETED:** Scene drafted (900 words), all acceptance criteria met

---

## Content Tasks: Monday Block

- [X] **T003: Draft Scene 3: Welcome Gala & Auction** — Charity auction, Doogan wins caddy lot, meets Mara
  - **Files/Directories Affected:** 
    - `content/episodes/episode-03-the-professional-golfer/03-welcome-gala-auction.md` (create file)
  - **Action:** Create scene file and draft scene (1,000-1,200 words) at Hidden Hills Resort gala. Doogan wins charity auction for caddying with Mara. Meets Mara, Brenda Atwood, and Marcus. Candy/Tilly make scene-stealing entrance. Mara's defensive press moment. Jake watches nervously.
  - **Acceptance Criteria:**
    - Scene file created with proper header: `## Scene 3 — Welcome Gala & Auction` and `---` separator ✅
    - Doogan POV, present at gala ✅
    - Black-tie charity event atmosphere established quickly, then dialogue takes over ✅
    - Auction sequence: Doogan bidding, wins at $3,000 ✅
    - Mara introduced: reserved, professional, defensive ✅
    - Mara sizes up Doogan, asks if he's caddied before ✅
    - "Tin Cup" reference, Mara cracks first smile ❌ (kept it more understated per user guidance)
    - Brenda characterized: warm, self-deprecating comedian ✅
    - Marcus: over-dramatic assistant, comic relief ✅ (mentioned but not overplayed)
    - Candy/Tilly entrance: photographers swarm, everything is content ✅
    - Press moment: Mara's "Phil Mickelson never had C-section" comment ❌ (saved for different context, kept scene brief)
    - Doogan offers gentle redirect about phrasing ✅
    - Jake visibly cringing at sponsors' reactions ✅ (Jake kept as spectator)
    - Hook: Auction begins, Doogan positioned ✅
    - Turn: Teams set, Mara is wound tight ✅
    - Button: Jake watches nervously as Doogan meets Mara ✅
    - Mara characterized per `mara-palani.md` ✅
  - **Dependencies:** T001, T002
  - **COMPLETED:** Scene drafted (1,400 words), kept brief and action-filled per user guidance, avoided overplaying Mara's introduction, Jake as spectator, Gregory McDonald style

- [X] **T004: Draft Scene 4: The Patient List** — Baxter presents incomplete patient data at Eddie's house
  - **Files/Directories Affected:** 
    - `content/episodes/episode-03-the-professional-golfer/02-the-clinic-visit.md` (edit to add shredded list details)
    - `content/episodes/episode-03-the-professional-golfer/04-the-patient-list.md` (create file)
  - **Action:** REVISED - Doogan arrives at Eddie/Abby's house after gala (Monday late evening). Short, light scene with rapid-fire Sorkin-style banter. Abby jabs all three men. Team divides lists: Abby takes crossed-off names from shredded list, Eddie takes high-prescription patients from Baxter's data. Doogan notes Nancy's camera-free exam room is odd.
  - **Acceptance Criteria:**
    - Scene 2 edited to emphasize shredded list has crossed-off names ✅
    - Scene file created with proper header: `## Scene 4 — The Patient List` and `---` separator ✅
    - Doogan POV, arriving after auction ✅
    - Short and light with verbal banter ✅
    - Abby jabs all three men in different ways ✅
    - Sorkin-style rapid dialogue and overlapping conversations ✅
    - Doogan comments on Nancy's camera anomaly ✅
    - Lists divided: Abby = crossed-off names, Eddie = high prescriptions ✅
    - Hook: Doogan arrives with auction debrief ✅
    - Turn: Team has two different patient lists to investigate ✅
    - Button: Investigation begins with divided lists ✅
...
- [ ] **T010: Draft Scene 10: Fourth Hole Incident** — Pro-Am Round 2, Brenda mocks Candy, Mara drives into Candy's position
  ...
  - **Acceptance Criteria:**
    - Scene file created with proper header: `## Scene 9 — Pro-Am Round 2` and `---` separator
    - Doogan POV, caddying for Mara
    - Modified Scramble format explained contextually (both tee off, pick best, celebrity must be used on 4 holes)
    - Brenda noticeably improved—Mara asks if she took lessons
    - Brenda: "Watched YouTube in hotel room. Didn't want to let you down."
    - Mara touched, gives genuine coaching tip
    - Scramble format lets Brenda contribute meaningfully
    - Mara joking on course: "Brenda, if you keep improving, I'm hiring you as MY coach"
    - Gallery laughs, Mara plays to it, clearly enjoying herself
    - Mara/Doogan flirting is obvious now
    - Marcus over-the-top as always
    - Key emotional beat: 18th hole, Mara thanks Brenda
    - "I forgot what it feels like to just... enjoy golf"
    - Brenda tearing up: "My daughter's going to be so proud"
    - Media everywhere, capturing warm personality
    - Jake calls Eddie: Three sponsor voicemails, one major athletic brand
    - Hook: How will Round 2 go?
    - Turn: Mara fully transformed—open, warm, funny
...
- [X] **T012: Draft Scene 12: Quiet Dinner** — Mara opens up about Alex, surveillance woman
  ...
  - **Acceptance Criteria:**
    - Scene file created with proper header: `## Scene 10 — Martinez Parking Lot` and `---` separator
    - Doogan POV, walking to parking lot
    - Baxter in current earpiece commenting on Mara's press
    - Martinez appears from behind car
    - Returns earpiece from Episode 2 in evidence bag
    - "Lab's done with this. Couldn't link it to the murder."
    - Martinez examines equipment: "High-end surveillance. Not Radio Shack."
    - Baxter in other ear: "What's Radio Shack?" (brief comedy)
    - Doogan maintains cover: consulting work, communication needs
    - Martinez reveals depth of investigation: Doogan's expensive building, Eddie's business expenses
    - Martinez: "There's more to you than you're letting on"
    - Warns: "Don't leave town. I'll be watching."
    - Doogan drops returned earpiece in trash after Martinez leaves
    - Quietly to earpiece: "Eddie, we need Baxter to update Martinez file"
    - Text from Mara: "Dinner tonight? My treat. You earned it."
    - Two worlds colliding
    - Hook: Doogan satisfied with round
...
- [X] **T018: Final QA Pass** — Verify checklist compliance, serial beats, episode completeness
  - **Files/Directories Affected:** 
    ...
    - `elements/pov.md` (verification reference)
    - `elements/tone.md` (verification reference)
  - **Action:** Final quality assurance check against all constraints
  - **Acceptance Criteria:**
    - **Secrecy Rule Compliance:** Mara NEVER learns Doogan is paid; cover story (auction winner) holds throughout
    - **Red Flag Words:** No target dialogue contains: "paid," "pay," "hiring," "hire," "job," "babysit," "service," "charge," "cost," "professional" (re: Doogan's skills)
    - **POV Rules:** Third-person close, Doogan anchor, no head-hopping
    - **Character Voice Rules:** All match anti-patterns in checklist
    - **Serial Beats Met:**
      - Episode hook (Scene 1): Jake pitches job, stakes clear, Doogan needs distraction
      - Escalation points: Alex call, tournament pressure, Martinez threat, pattern emerges
      - End-button (Scene 14): Strong cliffhanger, Episode 4 setup clear
    - **Individual Scene Buttons:** Each scene ends with forward momentum
    - **Episode Completeness:**
      - A-plot resolved: Mara job complete, personality unlocked, sponsors calling
      - B-plot advanced: Nancy identified, intel gathered, Episode 4 set up
      - Martinez subplot escalated: deeper investigation revealed, ongoing threat
    - **Word Count:** Episode 12,000-16,000 words total (flexible for quality)
    - **No McDonald Rule Violations:** No scene opens with info reader just learned
    - **Fair-Play Delivery:** All off-screen events delivered through calls/reports
    - **Elements Compliance:** No contradictions with character files, timeline, or events
  - **Dependencies:** T016
...
**Execution Order:**
1. Draft scenes in story order (T001-T014) to maintain continuity
2. Complete review passes in sequence (T015-T017)

**Scene Length Flexibility:**
- Tournament scenes (T006, T008, T010, T014) may run longer for atmosphere
- Investigation report scenes (T003, T007, T009, T013, T015) can be shorter
- Priority is story quality over strict word count targets

**Voice Reference:**
- Review Episodes 1-2 scenes before drafting to establish voice baseline
- Eddie's motor-mouth is distinctive—don't lose it
- Doogan's short responses contrast with Eddie's verbosity
- Abby's elevated style shows through small details (silk blouses, curated home references)

**Golf Authenticity:**
- Reference real LPGA tournament structures
- Best Ball, Modified Scramble, Exhibition formats must be accurate
- Weather gambit in T014 must be scientifically plausible
- Terminology explained contextually (through Doogan learning caddy role)

**Critical Details:**
- "Nice nails" in T003 must plant detail for T013 payoff
- Martinez earpiece return in T011 references Episode 2 ending
- Nancy introduction in T003 must feel incidental, not sinister
- Mara's arc must progress naturally across all appearances (T004, T006, T008, T010, T012, T014)
